...
const Navbar = () => {
  return (
    <nav className="bg-gradient-to-r from-cyan-500 to-blue-500 shadow dark:bg-gray-800">
      <div className="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize dark:text-gray-300">
        <NavLink
          className={({ isActive }) =>
            isActive
              ? "text-gray-800 transition-colors duration-200 transform dark:text-gray-200 border-b-2 border-white mx-1.5 sm:mx-6"
              : "text-gray-800 transition-colors duration-200 transform dark:text-gray-200   mx-1.5 sm:mx-6"
          }
          to={`/`}
        >
          Home
